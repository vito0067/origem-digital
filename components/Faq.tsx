...
const faqs = [
  {
    q: "Quanto custa?",
    a: "Sites profissionais a partir de R$ 987 de setup único + R$ 43/mês (com domínio, hospedagem e manutenção básica inclusos). Agentes de IA a partir de R$ 657 de setup + R$ 217/mês. O Pacote Completo tem 12% de desconto no setup combinado, com mensalidade de R$ 260 a R$ 381/mês conforme a combinação de site e agente escolhida. No diagnóstico gratuito indicamos exatamente o que faz sentido para o seu caso.",
  },
  {
