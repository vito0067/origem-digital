...
const services: Service[] = [
  {
    ...
    priceNote: "setup único + R$ 39/mês · versão completa com blog e formulários: R$ 1.497 + R$ 49/mês",
  ...
  },
  {
    ...
    priceNote: "setup único + R$ 197/mês · versão avançada com CRM e handoff: R$ 997 + R$ 297/mês",
  ...
  },
  {
    ...
    bullets: [
      ...
      "10% a 15% de desconto no setup combinado",
      "Mensalidade unificada de R$ 219/mês",
      "Uma única equipe cuidando de tudo",
      "Suporte contínuo incluso",
    ],
    price: "setup com desconto",
    priceNote: "10–15% off no setup somado + mensalidade unificada de R$ 219/mês",
